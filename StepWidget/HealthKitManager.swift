...
//
// NOTE POUR LE NÉOPHYTE : Ce fichier est une COPIE EXACTE du HealthKitManager.swift
// de l'app principale. Les deux targets (app + widget) ont besoin de leur propre
// copie car ils s'exécutent dans des processus séparés sur iOS. Toute modification
// doit être appliquée dans LES DEUX fichiers pour rester synchronisés.
